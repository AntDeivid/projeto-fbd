DROP TABLE IF EXISTS Usuario_Reponsavel;
DROP TABLE IF EXISTS Registro_Medico_Possiveis_Doencas_;
DROP TABLE IF EXISTS Medicacao_Efeitos_Colaterais_;
DROP TABLE IF EXISTS Medicacao_Contraindicacao;
DROP TABLE IF EXISTS Dieta_Alimentos;
DROP TABLE IF EXISTS Usuario_Parentesco;
